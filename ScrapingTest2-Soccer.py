...
for match in matches:
    ...
    csv_data.update({'Date': match_date, 'Time': match_time, 'Match ID': match_id, 'Season ID': season_id,
                     'Season Name': season_name, 'Team Name': home_name, 'Team ID': home_id, 'Opponent Team': away_name,
                     'Opponent Team ID': away_id, 'Winner': winner_name, 'Self Goals in First Half': self_first_half_goals,
                     'Opponent Goals in First Half': opp_first_half_goals, 'Total Self Goals': self_second_half_goals,
